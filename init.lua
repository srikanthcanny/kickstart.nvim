...
-- vim.opt.backup = false -- Default is false
-- Save undo history
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'css', 'javascript', 'typescript', 'tsx', 'json', 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
